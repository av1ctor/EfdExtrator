...
function LRE_cfop(db, ws)
	...
	ds = db_exec( db, [[
		select
			...
			((1.0 - iif(sum(an.valorOp) > 0.0, sum(an.bcIcmsST) / sum(an.valorOp), 1.0))) redBcIcmsST,
...
----------------------------------------------------------------------
-- criar resumos do Livro de Entradas
function LRE_criarResumos(db, ws)
...
----------------------------------------------------------------------
-- criar resumos do Livro de Saídas
function LRS_criarResumos(db, ws)
